...
def generate_promo(game_name, players_text, description):
    ...
    prompt = (
            ...
            f"Правила стиля:\n"
            f"1. Пиши как живой человек, живо и вовлекающе. Используй вопросительные ('?') и восклицательные ('!') знаки для эмоций.\n"
            f"2. Обязательно дели текст на 2-3 коротких абзаца. Не пиши сплошным полотном.\n"
            f"3. КАТЕГОРИЧЕСКИ ЗАПРЕЩЕНО использовать списки, буллеты, 'ёлочки' или маркеры.\n"
            f"4. Не используй длинные тире (—), заменяй их на дефисы (-) или запятые.\n\n"
            f"Формат ответа СТРОГО такой:\n"
            f"🎮 Игра недели: {game_name}!\n"
            f"👥 Количество игроков: {players_text}\n\n"
            f"📖 Описание:\n[Твой разделенный на абзацы и эмоциональный текст]\n\n"
